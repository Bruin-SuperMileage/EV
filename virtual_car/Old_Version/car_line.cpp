...
double car::get_x() {return m_x;}
double car::get_y() {return m_y;}
vector<double> car::get_position()
{
    vector<double> position;
    position.push_back(m_x);
    position.push_back(m_y);
    position.push_back(m_z);
    return position;
}
...
void car::travel(double pos, double coordinate_angle) 
{
    m_x += pos * sin(coordinate_angle);
    m_y += pos * cos(coordinate_angle);
    m_z += pos * cos(m_orientation);
    cout << "Angle: " << coordinate_angle << endl;
}
